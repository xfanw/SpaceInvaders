...
namespace SpaceInvaders
{
    public class BoxSpriteMan : Manager
    {
        ...
        public static BoxSprite Add(BoxSprite.NAME name,  float x, float y, float w, float h, Azul.Color pColor = null)
        {
            Debug.Assert(pMan != null);
            ...
            pSprite.Set(name, x, y, w, h, pColor);
            return pSprite;
        }
        ...
        public static BoxSprite Find(BoxSprite.NAME name)
        {
            ...
            while (ptr != null)
            {
                if (((BoxSprite)ptr).GetName() == name)
                {
                    return (BoxSprite)ptr;
                }
